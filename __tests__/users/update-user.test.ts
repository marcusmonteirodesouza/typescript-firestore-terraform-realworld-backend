...
describe('PUT /user', () => {
  ...
  test('given a valid request with all fields should return http status code 200 and the user', async () => {
  ...
  test('given a valid request with email should return http status code 200 and the user', async () => {
    const userAndPassword = await usersClient.registerRandomUser();
  ...
  test('given a valid request with password should return http status code 200 and the user', async () => {
    const userAndPassword = await usersClient.registerRandomUser();
  ...
  test('given a valid request with bio should return http status code 200 and the user', async () => {
    const userAndPassword = await usersClient.registerRandomUser();
  ...
  test('given a valid request with image should return http status code 200 and the user', async () => {
    const userAndPassword = await usersClient.registerRandomUser();
